...
export default function HowToBuy() {
  ...
  return (
    <section
      className="h-screen bg-[#4f7a36] relative overflow-hidden px-4 pb-6 md:px-6"
      style={{
    ...
    >
      <div className="z-10 w-full max-w-[1800px] mx-auto relative scale-50 md:scale-60 lg:scale-65 xl:scale-70 origin-center">
        ...
        {/* Grid Container */}
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 items-end gap-4">
          ...
          >
            ...
            <div className="relative w-full scale-75">
              ...
              {/* Content Overlay */}
              <div className="absolute inset-0 p-3 md:p-6 lg:p-8 mt-6 md:mt-8 flex items-center">
                  ...
                  {steps.map((step, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <h3 className="scale-75 origin-left">
                          <img src={step.title} className="object-contain" />
                        </h3>
                        <p className="my-0.5 text-[11px] md:text-[13px] jockey text-[#E5EED2] leading-tight mb-0.5">
                          {step.description}
                        </p>
                        {step.button && (
                          <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="inline-block scale-75 origin-left"
                          >
                            <img
                              src={step.button}
                              className="object-contain"
        ...
        <motion.a
          ...
          className="block mt-4 relative z-10"
        >
          <Image
            src="/Btn htb.png"
            alt="Tutorial Button"
